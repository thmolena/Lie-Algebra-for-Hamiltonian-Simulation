...
\pagestyle{fancy}\fancyhf{}\fancyhead[L]{\footnotesize\itshape Lie-algebraic spectral truncation of the product-formula residual}\fancyhead[R]{\footnotesize\thepage}\renewcommand{\headrulewidth}{0.4pt}
...
\title{\bfseries Learning and compressing the product-formula residual: a Lie-algebraic spectral truncation that advances the Hamiltonian-simulation error--cost frontier}
